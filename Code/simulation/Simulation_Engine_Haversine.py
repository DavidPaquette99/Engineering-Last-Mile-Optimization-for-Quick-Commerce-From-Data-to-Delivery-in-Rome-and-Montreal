...
from assignment_strategies.Naive_Assignment_Haversine import naive_assignment
from assignment_strategies.Hungarian_Assignment_Haversine import hungarian_assignment
from assignment_strategies.Anfis_Assignment_Haversine import load_anfis_regression_model, anfis_assignment
import assignment_strategies.Pairwise_Assignment_Haversine as PA
    ...
    while current_minute < 24 * 60:
        ...
        if active_orders:
            if assignment_mode == "naive":
                naive_assignment(available_couriers, active_orders, current_minute)

            elif assignment_mode == "hungarian":
                hungarian_assignment(available_couriers, active_orders, current_minute)
