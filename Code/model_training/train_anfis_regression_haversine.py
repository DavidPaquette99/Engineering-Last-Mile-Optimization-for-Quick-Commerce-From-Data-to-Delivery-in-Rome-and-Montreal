...
for city in CITIES:
    ...
    df = pd.read_csv(os.path.join(DATA_PATH, f"{city}_regression_training_data_haversine_nobatch.csv"))
    ...
    model.save_model(save_path=DATA_PATH, filename=f"{city}_anfis_model_haversine.pkl")
    joblib.dump(scaler_X, os.path.join(DATA_PATH, f"{city}_scaler_X_haversine.pkl"))
    joblib.dump(scaler_y, os.path.join(DATA_PATH, f"{city}_scaler_y_haversine.pkl"))
